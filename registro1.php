...
if($_POST['nombre']!="" && $_POST['idp']!="")
 ...
 $conexion=mysql_connect("127.0.0.1","root","") or
  ...
  mysql_query("insert into consultas_medicas(nombre_paciente,fecha_consulta,telefono,nombre_medico,consultorio,diagnostico) values                                ('$_POST[nombre]','$_POST[fecha]','$_POST[idp]','$_POST[idm]','$_POST[consultorio]','$_POST[diag]')", $conexion)
